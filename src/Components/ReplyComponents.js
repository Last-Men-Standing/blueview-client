...
class NewReply extends React.Component {
  ...
  // Create reply and hide new reply interface
  handleSubmit(event) {
    ...
    this.props.cancelReply(); // Hide new reply form
  }
    ...
    return (
      <div className="replyFeedBody">
        ...
        {this.state.creatingReply && (
          <NewReply cancelReply={this.cancelReply} postid={this.props.postid} 
